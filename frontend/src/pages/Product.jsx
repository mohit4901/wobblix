...
const Product = () => {
  ...
  return productData ? (
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100 px-4 sm:px-10 lg:px-16'>
      ...
      <div className='mt-20'>
        ...
        <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500'>
          ...
          <p>
            E-commerce websites typically display products or services along with detailed descriptions, images, prices, and variations.
          </p>
        </div>
      </div>
