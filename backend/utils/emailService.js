...
const resend = new Resend(process.env.RESEND_API_KEY || "re_dummy_key_for_local_development");
...
const sendOrderConfirmationEmail = async (order, userEmail) => {
    try {
        ...
        const { data, error } = await resend.emails.send({
            from: process.env.RESEND_FROM_EMAIL || 'Wobblix <support@wobblixclothing.in>',
            to: userEmail,
